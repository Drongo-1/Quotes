...
export class QuoteComponent implements OnInit {
  ...
  userQuotes = [
    new Quote(1, 'ny fool can write code that a computer can understand. Good programmers write code that humans can understand.', '-	Martin Fowler', 0, 0, new Date(2021,1,5), 'sam'),
    ...
    new Quote(4, 'Java is to JavaScript what car is to Carpet.',  'Chris Heilmann', 0, 0, new Date(2018,7,10), 'Weshy'),
